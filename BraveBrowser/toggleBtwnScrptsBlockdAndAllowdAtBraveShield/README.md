...
*'All scripts allowed' and 'Scripts blocked' refers to the part under 'Brave Shields' where user can block JavaScript scripts from running — or instead, allow them to run — on domain (level) of currently opened page/url.*
